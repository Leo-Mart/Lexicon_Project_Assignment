...
export default function BigModal({
    ...
    return (
        <>
            ...
            >
                <nav className="bg-bg-header dark:bg-bg-header-dark text-text dark:text-text-light  rounded-t-md flex items-center justify-between px-4 py-2">
                ...
                <form
                    className="bg-bg dark:bg-bg-dark py-3 px-3 flex-1 flex flex-col min-h-0"
